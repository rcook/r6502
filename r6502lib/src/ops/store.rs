...
pub(crate) fn dec(state: &mut CpuState, addr: u16) {
...
pub(crate) fn inc(state: &mut CpuState, addr: u16) {
...
pub(crate) fn sta(state: &mut CpuState, addr: u16) {
...
pub(crate) fn stx(state: &mut CpuState, addr: u16) {
...
pub(crate) fn sty(state: &mut CpuState, addr: u16) {
