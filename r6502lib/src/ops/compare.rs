...
pub(crate) fn cmp(s: &mut VmState, operand: u8) -> OpCycles {
...
pub(crate) fn cpx(s: &mut VmState, operand: u8) -> OpCycles {
...
pub(crate) fn cpy(s: &mut VmState, operand: u8) -> OpCycles {
